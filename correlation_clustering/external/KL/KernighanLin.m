function labels = KernighanLin(correlationMatrix_p1,dim)
correlationMatrix_p2 = [correlationMatrix_p1{:}];
correlationMatrix_p3 = cell2mat(correlationMatrix_p2); 
correlationMatrix = double(reshape(correlationMatrix_p3,dim,dim));
